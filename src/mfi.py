...
META = {
    ...
    "family": "MR",
    "params": {"n": 14, "oversold": 20, "exit_level": 50, "top_n": 5, "cost": 0.001, "capital": 1_000_000},
...
def backtest(data: dict, n=14, oversold=20, exit_level=50, top_n=5, cost=0.001, capital=1_000_000) -> tuple[list, pd.DataFrame]:

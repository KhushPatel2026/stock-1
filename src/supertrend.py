...
META = {
    "name": "Supertrend",
    "family": "Trend",
    "params": {"atr_n": 14, "mult": 3.0, "top_n": 5, "cost": 0.001, "capital": 1_000_000},
...
def backtest(data: dict, atr_n=14, mult=3.0, top_n=5, cost=0.001, capital=1_000_000) -> tuple[list, pd.DataFrame]:
